...
function(get_hash_for_ref ref out_var err_var)
  execute_process(
    COMMAND "D:/Program Files/Git/mingw64/bin/git.exe" rev-parse "${ref}"
...
execute_process(
  COMMAND "D:/Program Files/Git/mingw64/bin/git.exe" show-ref "apic2d"
  WORKING_DIRECTORY "D:/Documents/GitHub/apic2d/build-MinGW_Makefiles/_deps/thirdparty-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("apic2d" tag_sha error_msg)
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(fetch_required YES)
  set(checkout_name "origin/apic2d")
...
if(fetch_required)
  ...
  execute_process(
    COMMAND "D:/Program Files/Git/mingw64/bin/git.exe" fetch --tags --force "origin"
    WORKING_DIRECTORY "D:/Documents/GitHub/apic2d/build-MinGW_Makefiles/_deps/thirdparty-src"
...
if(git_update_strategy MATCHES "^REBASE(_CHECKOUT)?$")
  ...
  execute_process(
    COMMAND "D:/Program Files/Git/mingw64/bin/git.exe" symbolic-ref -q HEAD
    WORKING_DIRECTORY "D:/Documents/GitHub/apic2d/build-MinGW_Makefiles/_deps/thirdparty-src"
  ...
  if(current_branch STREQUAL "")
    ...
    execute_process(
      COMMAND "D:/Program Files/Git/mingw64/bin/git.exe" for-each-ref "--format='%(upstream:short)'" "${current_branch}"
      WORKING_DIRECTORY "D:/Documents/GitHub/apic2d/build-MinGW_Makefiles/_deps/thirdparty-src"
...
execute_process(
  COMMAND "D:/Program Files/Git/mingw64/bin/git.exe" status --porcelain
  WORKING_DIRECTORY "D:/Documents/GitHub/apic2d/build-MinGW_Makefiles/_deps/thirdparty-src"
  RESULT_VARIABLE error_code
...
if(need_stash)
  execute_process(
    COMMAND "D:/Program Files/Git/mingw64/bin/git.exe" stash save --quiet;--include-untracked
    WORKING_DIRECTORY "D:/Documents/GitHub/apic2d/build-MinGW_Makefiles/_deps/thirdparty-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
endif()
...
if(git_update_strategy STREQUAL "CHECKOUT")
  execute_process(
    COMMAND "D:/Program Files/Git/mingw64/bin/git.exe" checkout "${checkout_name}"
    WORKING_DIRECTORY "D:/Documents/GitHub/apic2d/build-MinGW_Makefiles/_deps/thirdparty-src"
    COMMAND_ERROR_IS_FATAL ANY
  )
else()
  execute_process(
    COMMAND "D:/Program Files/Git/mingw64/bin/git.exe" rebase "${checkout_name}"
    WORKING_DIRECTORY "D:/Documents/GitHub/apic2d/build-MinGW_Makefiles/_deps/thirdparty-src"
    RESULT_VARIABLE error_code
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "D:/Program Files/Git/mingw64/bin/git.exe" rebase --abort
      WORKING_DIRECTORY "D:/Documents/GitHub/apic2d/build-MinGW_Makefiles/_deps/thirdparty-src"
    )
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      if(need_stash)
        execute_process(
          COMMAND "D:/Program Files/Git/mingw64/bin/git.exe" stash pop --index --quiet
          WORKING_DIRECTORY "D:/Documents/GitHub/apic2d/build-MinGW_Makefiles/_deps/thirdparty-src"
          )
      endif()
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/Documents/GitHub/apic2d/build-MinGW_Makefiles/_deps/thirdparty-src'."
    ...
    execute_process(
      COMMAND "D:/Program Files/Git/mingw64/bin/git.exe" tag -a
...
if(need_stash)
  ...
  if(error_code)
    ...
    execute_process(
      COMMAND "D:/Program Files/Git/mingw64/bin/git.exe" reset --hard --quiet
      WORKING_DIRECTORY "D:/Documents/GitHub/apic2d/build-MinGW_Makefiles/_deps/thirdparty-src"
    )
    execute_process(
      COMMAND "D:/Program Files/Git/mingw64/bin/git.exe" stash pop --quiet
      WORKING_DIRECTORY "D:/Documents/GitHub/apic2d/build-MinGW_Makefiles/_deps/thirdparty-src"
      RESULT_VARIABLE error_code
    )
    if(error_code)
      ...
      execute_process(
        COMMAND "D:/Program Files/Git/mingw64/bin/git.exe" reset --hard --quiet ${head_sha}
        WORKING_DIRECTORY "D:/Documents/GitHub/apic2d/build-MinGW_Makefiles/_deps/thirdparty-src"
      )
      execute_process(
        COMMAND "D:/Program Files/Git/mingw64/bin/git.exe" stash pop --index --quiet
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/Documents/GitHub/apic2d/build-MinGW_Makefiles/_deps/thirdparty-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
